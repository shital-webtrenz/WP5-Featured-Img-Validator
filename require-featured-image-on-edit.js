jQuery(document).ready(function($) {
        ...
        function disablePublishAndWarn(message) {
            ...
            $('#nofeature-message').addClass("components-notice is-error")
                .html('<div class="components-notice__content">'+message+'</div>'); 
           
             if (isGutenberg()) {
                $('.editor-post-publish-panel__toggle').attr('disabled', 'disabled');
            } else {
                $('.editor-post-publish-button').attr('disabled','disabled');
            }
        }
        ...
        function clearWarningAndEnablePublish() {
            ...
            if (isGutenberg()) {
                ...
                $('.editor-post-publish-button').removeAttr('disabled');
            }
        }
